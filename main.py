...
if score < 30:
    ...
    print("Gut. Bilde Dir aber bloß nichts drauf ein du Pisser!")
else:
    print("Sören, der allmächtige Gott wäre stolz auf dich. Noch heute erzählt man Geschichten über dieses größte Genie aller Zeiten")
print(f"{score} % Richtige Antworten")

print(input("Möchten Sie ein neues Spiel spielen (Ja/Nein)?: "))